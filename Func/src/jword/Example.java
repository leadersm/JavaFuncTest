...
public class Example {
    ...
    {
    	File file = new File("./jwordExample.docx");
    	...
    	try {
			...
			addImage(doc, 408, 346, "./guandian.png");
	...
	private static void addLogo(WordDocument doc) throws IOException {
		// TODO Auto-generated method stub
		Picture picture = new Picture("./twsmlogo.png");
	...
	private static void addHeaderAndFooter(WordDocument doc) throws IOException {
		Picture picture = new Picture("./headerImage.png");
